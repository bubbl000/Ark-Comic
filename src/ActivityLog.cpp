...
static const wchar_t* ACTIVITY_CLASS = L"ArkComicActivityLog";
static const wchar_t* ACTIVITY_TITLE = L"活动日志 — Ark Comic（F12 开关 · 右键复制）";
...
Snapshot& Current() { static Snapshot s; return s; }
}
